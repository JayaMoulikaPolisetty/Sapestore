	...
	<div class="container-fluid book-store-wrapper">
		...
		<div class="row details-wrapper-container">
			...
			<div class="col-lg-8 form-container">
				...
				<br>
				<hr>
				<form id="regForm" action="summary" method="post" class="form-summary">

					<div class="inputData">
						<label id="label2">Address Line 1<span class="color-red">*</span></label>
						<input type="text" name="addressLine1"
							value="${shippingAddress.addressLine1 }" class="inputName" required><br>
					</div>
					<br>

					<div class="inputData">
						<label id="label2">Address Line 2 </label> <input type="text"
							value="${shippingAddress.addressLine2 }" name="addressLine2"><br>
					</div>
					<br>
					...
					<div class="inputData">
						...
						<select name="city" value="" style="width: 230" required>
							...
							<option disabled="disabled" style="background-color: #3E3E3E"><font
									color="#FFFFFF"><i>-Telangana-</i></font></option>
							<option>Hyderabad/Secunderabad</option>
							<option>Nizamabad</option>
							<option>Warangal</option>
							<option>Telangana-Other</option>
							<option disabled="disabled" style="background-color: #3E3E3E"><font
					...
					<br>
					<div class="inputData">
						<label id="label2">Zip Code<span class="color-red">*</span>
						</label>
						<div class="zipsize">
							<input type="text" name="pin" value="${shippingAddress.pin }"
								required minlength="6" maxlength="6" class="inputName"><br>
						</div>
					</div>
					<br>
					<div class="inputData">
						<label id="label2">Phone Number<span class="color-red">*</span>
						</label> <input type="text" value="${shippingAddress.phoneNumber }"
							name="phoneNumber"  required  minlength="10" maxlength="10"><br>
					</div>
					<br> <br> <input type="submit" value="Save & Continue"
						id="subButton">
				</form>
				<br> <br> <br>
...
$('.inputName').on('keypress', function (event) {
    ...
    if (!regex.test(key)) {
       ...
       if(!errorIsAvialable) {
	       $('#inputName').after('<span id="nameError">No Special Charecters are allowed</span>');
       }
       return false;
    }
    $('#nameError').empty();
