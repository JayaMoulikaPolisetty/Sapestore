   ...
   <body>
      ...
      <div class="container-fluid book-store-wrapper">
         ...
         <div class="row details-wrapper-container">
            <div class="col-lg-3  col-sm-3 quicklinks"  style="background-color: white"">
               <h3>
                  <b>Book Categories</b>
               </h3>
               <c:forEach var="category" items="${category}">
                  <%-- <h3 data-toggle="modal" data-target="#myModal">${category}</h3>
                     --%>
                  <a href="categoryBookList/${category}">${category}</a>
               </c:forEach>
            </div>
            <div class="col-lg-9">
         ...
         <div class="row">
          <div class="col-lg-12">
          		<div class="header-wrapper">
          			<h1 align="center" class="header-dashboard">Dashboard</h1>
          			<div id="add">
                      <a href="addBookform"><button type="button"
                        class="button  btn-info">Add Book</button></a>
                   </div>
          		
          		</div>       
               <div class="add-button-update">
                  <h2 class="update-text">Search Books to Update/Delete</h2>
               </div>
               </div>
               </div>
...
<div id="myDIV"> -->
         <div class="row">
          <div class="col-lg-12">
           ...
           <div class="row">
                   <b>
	                  <h3 align="center">All Books In Store</h3>
	               </b>
                  </div>  
               
                  <div class="row">
                  <div id="row book-category" class="col-md-12 book-category-wrapper">
              <c:forEach var="book" items="${allBookList}">
                   <div class="col-sm-6 col-md-3  book-card">
                           <div id="thumbnail" width="100px" height="100px">
                              <img src="${context}${book.book_img}"
                                 alt="Generic placeholder thumbnail" width="100px"
                                 height="100px">
                              
                             <div class="caption">  
                                 
                              <a href="productdescription/${book.iSBN}">
                                 <h3>${book.title }</h3>
                              </a>
                            ...
                            <%--   <h4>${book.active }</h4> --%>
                              ...
                              <h4>
                               ...
                               <div class="but"><input type="text" value="${book.active}" disabled></input>
                                <a href="editBookForm/${book.iSBN}" class="btn btn-primary" 
                                    role="button" style="background-color: #31b0d5;border-color: #46b8da;"> update </a>
                           </div>
                           </div>
                           </div>
                        </div>  
      ...
      <script>
         function multiSearch() {
           ...
           */
           ...
           var url = ctx+'/searchresult?title=' + obj.title + '&category=' + obj.category + '&author=' + obj.author + '&publisher=' + obj.publisher ;
           console.log(url);
           fetch(url).then(res => { 
           	res.json().then(data => {
           			...
           			if (data.length) {
	           			data.forEach(item => {
	           				...
	           				const searchTemplate = "<div class='col-sm-6 col-md-3'><br><div class='thumbnail'><img src=" + ctx + book_img + " alt='image missing'></div><div class='caption'><a href='productdescription/" + iSBN + "'><h3>" + title + "</h3></a><h4>ISBN:" + iSBN + "</h4><h4><i class='fa'>&#xf156;</i>" + price + "</h4></div></div>";
