		...
		<div class="row details-wrapper-container">
			...
			<div class="col-lg-9">
				...
				<form action="orderConfirmation" method="post">
					<input class="radio-input" type="radio" name="mode" value="cod">Cash
					on Delivery </br> <input type="radio" name="mode" value="card" disabled>Debit
					card/Credit Cart</br> <br> <br> 
					<button type="submit"
